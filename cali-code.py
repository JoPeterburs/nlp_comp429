...
param_grid = {
    ...
    "ngram_range": [(1,1), (1,2)],
    "C": [0.01, 0.1, 1, 10],
    "l1_ratio": [0, 0.5, 1]   # replaces penalty
}
...
for max_df, ngram_range, C, l1_ratio in product(
    param_grid["max_df"],
    ...
    if score > best_score:
        best_score = score
        best_params = (max_df, ngram_range, C, l1_ratio)
        best_model = model

print("\n DEV TUNING RESULTS")
print("Best Dev Accuracy:", best_score)
print(f"Best Params: max_df={best_params[0]}, ngram_range={best_params[1]}, C={best_params[2]}, l1_ratio={best_params[3]}")
